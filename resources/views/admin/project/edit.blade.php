  ...
  <div class="class="content-wrapper"">
    <div class="content-header">
      <section class="content-header">
        <h1>
        Projeto: {{ $result->project[0]->name}}
        
        </h1>
        <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>{{ $result->project[0]->name}}</a></li>
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-header with-border">
                    ...
                    <form role="form" method="POST" action="{{ route('course.add') }}">
                      ...
                      <div class="box-body">
                        <div >
                          <label for="projectName">Projeto :{{ $result->project[0]->name }}</label>
                          		<ul class="list-group">
                                		...
                                		@foreach ($curso->modulos as $i =>  $modulos)
						  				<li class="list-group-item" style="    background-color: #5fa5ce; color: rgba(255, 255, 255, 0.9);">Módulo : {{ $modulos->name }}
											...
											<a href="https://localhost/gte-builder/public/home/admin/course/listProject" class="" aria-expanded="true">
						  					...
						  					<li class="list-group-item" style="font-weight:normal;"><i class="fa fa-fw fa-html5"></i> - {{ $template->name }}<a href="https://localhost/gte-builder/public/home/admin/template/edit/{{ $template->id }}" class="" aria-expanded="true"><i style="margin-right: 300px; " class="fa fa-fw fa-edit"></i></a></li>
						  					@endforeach
